                ...
                <nav class="w-full lg:w-64 shrink-0 space-y-1">
                    ...
                    <button type="button" data-tab="email" 
                        ...
                        <div class="ml-auto flex items-center gap-2">
                            ...
                            @else
                                {{-- Alert State: Badge + Pulsing Red Dot --}}
                                <span class="px-1.5 py-0.5 rounded text-[10px] font-bold bg-rose-100 text-rose-700 uppercase tracking-wide border border-rose-200">
                                    Action Needed
                                </span>
                                <span class="flex h-2.5 w-2.5 relative">
