...
@section('content')
    ...
    {{-- Added id="loginForm", novalidate, and @valid-submit --}}
    <form id="loginForm" novalidate x-data="{ loading: false }" @valid-submit="loading = true" method="POST" action="{{ route('login') }}" class="space-y-5">
        @csrf
