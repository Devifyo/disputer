@php $page = \App\Models\CmsPage::findBySlug('privacy-policy'); @endphp

@extends('layouts.marketing')

@section('title', 'Privacy Policy — Unjamm')
@section('meta_description', 'How Unjamm collects, uses and protects your data when we pursue flight compensation on your behalf.')
