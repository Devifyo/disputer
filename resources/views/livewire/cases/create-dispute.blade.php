<div class="w-full min-h-screen h-auto bg-gray-50 pb-32 overflow-y-auto"
     x-data
     @trigger-save-contact-prompt.window="
        Swal.fire({
            title: 'Save Contact Email?',
            text: 'This institution does not have a saved email. Do you want to save this one for future use?',
            icon: 'question',
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                $wire.executeFinalize(true);
            } else if (result.isDenied) {
                $wire.executeFinalize(false);
            }
        });
     ">
    <div class="w-full min-h-screen h-auto bg-gray-50 pb-32 overflow-y-auto">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <select wire:model.live="categoryId" 
                                                class="w-full px-4 py-3 bg-white border @error('categoryId') border-rose-500 @else border-slate-300 @enderror rounded-xl outline-none focus:border-blue-500">
                                    ...
                                    <button wire:click="submitCustom" 
                                        ...
                                        {{-- Default Text (Hides when loading) --}}
                                        <span wire:loading.remove wire:target="submitCustom">Continue</span>
                                        
                                        {{-- Spinner & Loading Text (Shows when loading) --}}
                                        <div wire:loading.flex wire:target="submitCustom" class="items-center gap-2">
                            ...
                            <div class="lg:col-span-1 space-y-4">
                                ...
                                @else
                                    ...
                                    <button wire:click="checkAndPromptContact" wire:loading.attr="disabled" class="w-full py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 text-sm">
                                        <div wire:loading.class="hidden" wire:target="checkAndPromptContact, executeFinalize" class="flex items-center gap-2"><span>Create Case</span><i data-lucide="send" class="w-4 h-4"></i></div>
